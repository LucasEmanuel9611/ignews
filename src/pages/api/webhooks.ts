...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  if (req.method === "POST") {
    ...
    // autenticando a requisação do stripe
    try {
    ...
    if (relevantEvents.has(type)) {
      ...
      //só vai criar nova subscription caso o event seja completed ou created
      try {
        switch (type) {
        ...
        // se retornar erro para stripe ele ficará tentando
